...
def save_data():
    ...
    con = mysql.connect(host="localhost",user="root",password="",database="billingkavi")
    cursor = con.cursor()
    cursor.execute("insert into kavi values('"+ bill +"','"+ date_time +"','"+ cost +"','"+ service_charge +"','"+ tax +"','"+ total_cost +"')")
